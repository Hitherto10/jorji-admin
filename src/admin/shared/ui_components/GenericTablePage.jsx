...
import { Table, Toolbar, Pagination, ErrorMessage, Loading, ConfirmDialog, Modal, Form, FormatCell } from './'
...
export default function GenericTablePage({ tableKey, tableDef }) {
  ...
  // No column filters for the generic page — pass empty stable object
  const columnFilters = {}

  const { rows, loading, error, total, load } = useTableData(
      tableKey, tableDef, search, page, columnFilters, sortField, sortOrder
  )
